       ...
       <div class="row justify-content-center">
            ...
            <div class="card">
              ...
              <div class="card-header success" >
                  <h3 class="mb-0">
                    <i class="fas fa-check-circle"></i> 現在のプランは <span style="color: green !important"> {{ \App\Model\PlanPurchase::where('id',$userPurchasePlan->purchase_plan_id)->get()->first()->name}} </span>です。
                  </h3>
              </div>
            </div>
          @endif
