...
<div class="offset-sm-2 col-sm-8 mb-4">
   ...
   {{--  @if ($errors->any())
    ...
    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
      <li class="nav-item ">
        <a class="nav-link active" id="updateprofile-tab" data-toggle="pill" href="#updateprofile" role="tab" aria-controls="updateprofile" aria-selected="true">個人情報更新</a>
      </li>
      <li class="nav-item">
      ...
      <div class="tab-pane fade show active" id="updateprofile" role="tabpanel" aria-labelledby="updateprofile-tab">
            ...
            @endif 
                ...
                <div class="card-footer">
                    <div class="row pt-3 pb-3">
                        <button type="submit" class="mx-auto btn btn-secondary text-white btn-primary btn-lg  ">次へ</button>
                    </div>
                </div>
